        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-amber-50 border border-amber-500 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl">
                <div class="p-4 text-gray-900 dark:text-gray-100">
                    Form Input <span class="text-amber-500 font-bold">Peminjaman</span>
                </div>
            </div>
                    ...
                    <div class="flex gap-5">
                        <div class="bg-white w-full p-6 border border-gray-200 rounded-xl">
                            <form class="w-full">
                                ...
                                <div class="mb-5">
                                    <label for="jumlah_pemgembalian"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah
                                        Pengembalian</label>
                                    <input type="number" id="jumlah_pemgembalian" name="jumlah_pemgembalian"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required />
                                </div>
                                <button type="submit"
